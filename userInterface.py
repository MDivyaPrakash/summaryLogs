...
def getall_function():
    ...
    for i,val in enumerate(output_db):
        ...
        new_text = gr.Radio(["Approve", "Deny"],value= "Approve", label=keyval , info = message_val, visible=True)
...
with gr.Blocks(theme=gr.themes.Default()) as demo:
        ...
        with gr.Tab("Document Addition Screen"):
            ...
            doc_submit.click(document_addition_screen, inputs=[qn_input,url_input],outputs=op_list)
